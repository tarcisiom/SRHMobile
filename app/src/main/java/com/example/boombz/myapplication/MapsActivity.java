...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(41.5594118,-8.3975468);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Prometeu"));
    ...
    public void estradasProcessWithRetrofit(){
        ...
        final Call<EstradasResponse> mService = App.getEstradasService().listEstradas();

        mService.enqueue(new Callback<EstradasResponse>() {
            @Override
            public void onResponse(Response<EstradasResponse> response, Retrofit retrofit) {
                EstradasResponse response1 = response.body();
